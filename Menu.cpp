...
void Menu::printLogo()
{
	...
	cout << logo;
	Controller::gotoXY(67, 0);
	Controller::setConsoleColor(BRIGHT_WHITE, BLUE);
	cout << "Hoang Nhan - Ton That Hoan";
	Controller::gotoXY(69, 1);
	cout << "23127094 - 23127046";
	Controller::gotoXY(40, 7);
...
void Menu::changeOption(bool direction, bool flag) //0: lên, 1: xuống
{
	...
	Controller::setConsoleColor(BRIGHT_WHITE, BLACK);
	Controller::gotoXY(78 - (int)options[current_option].length() / 2, top + current_option % 4 * 2);
	cout << options[current_option];
	if (flag)
	{
		Controller::gotoXY(88, top + current_option % 4 * 2);
		putchar(32);
		Controller::gotoXY(68, top + current_option % 4 * 2);
		putchar(32);
	}
...
void Menu::helpScreen()
{
	...
	cout << "Dev 1: Hoang Nhan (23127094)";
	Controller::gotoXY(left + 31, top + 21);
	cout << "Dev 2: Ton That Hoan (23127046)";
